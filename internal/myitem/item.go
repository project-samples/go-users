...
type Item struct {
	...
	Price       *float64   `json:"price,omitempty" gorm:"column:price" bson:"price,omitempty" dynamodbav:"price,omitempty" firestore:"price,omitempty"`
	...
	Categories  []string   `json:"category,omitempty" gorm:"column:category" bson:"category,omitempty" dynamodbav:"category,omitempty" firestore:"category,omitempty"`
