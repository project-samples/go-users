...
type Cinema struct {
	...
	Latitude  *float64            `json:"latitude" gorm:"column:latitude" validate:"omitempty,max=255"`
	Longitude *float64            `json:"longitude" gorm:"column:longitude" validate:"omitempty,max=255"`
	ImageURL  *string             `json:"imageURL,omitempty" gorm:"column:imageurl" validate:"max=300"`
	CreatedBy *time.Time          `json:"createdBy" gorm:"column:createdBy"`
	CreatedAt *time.Time          `json:"createdAt" gorm:"column:createdAt"`
	UpdatedBy *time.Time          `json:"updatedBy" gorm:"column:updatedBy"`
	...
	Info      *Info               `json:"info,omitempty" gorm:"-"`
}
