...
type Job struct {
	...
	Description    *string    `json:"description,omitempty" gorm:"column:description" dynamodbav:"description,omitempty" firestore:"description,omitempty" validate:"omitempty,max=2000"`
	...
	Requirements   *string    `json:"requirements,omitempty" gorm:"column:requirements" dynamodbav:"requirements,omitempty" firestore:"requirements,omitempty" validate:"omitempty,max=2000"`
	Benefit        *string    `json:"benefit,omitempty" gorm:"column:benefit" dynamodbav:"benefit,omitempty" firestore:"benefit,omitempty" validate:"omitempty,max=1000"`
